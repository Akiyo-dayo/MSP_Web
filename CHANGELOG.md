...
## v2.0.1 — 2026-04-14 · 修复与优化

### 🖥️ 状态页 (status.html)
- 补全缺失的页脚 footer，与全站其他页面保持一致
- 移除 drawer 区域多余的内联样式，统一使用 CSS 类

### 🏠 首页 (app.js)
- **Bot 可用状态卡片**：点击整个卡片现在跳转到 status.html 而非打开侧边栏菜单
- "异常明细" 按钮仍保留打开侧栏的功能

### 🔧 后端
- **bot_server.py / community_server.py**：修复 GBK 编码环境下 emoji 字符导致启动崩溃的问题
