...
(function () {
  ...
  /* ---------- 九星（从徽记原图连通域实测的精确星位） ---------- */
  const NINE_STARS = [
    { x: 0.266, y: -0.595, s: 0.99 }, { x: 0.560, y: -0.515, s: 1.00 }, { x: -0.037, y: -0.514, s: 0.99 },
    { x: 0.778, y: -0.296, s: 1.01 }, { x: 0.860, y: -0.002, s: 1.00 }, { x: 0.781, y: 0.295, s: 1.01 },
    { x: -0.035, y: 0.513, s: 1.00 }, { x: 0.559, y: 0.516, s: 1.01 }, { x: 0.263, y: 0.594, s: 1.01 },
  ].map((p, i) => ({
    ...p,
